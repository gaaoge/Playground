...
var _Sign = __webpack_require__(92);
...
var router = new _vueRouter2.default({
    // mode: 'history',
    routes: [{ path: '/', component: _Vuex2.default }, { path: '/sign', component: _Sign2.default }, { path: '/test', component: _Test2.default }, { path: '/vuex/(\\d*)', component: _Vuex2.default }]
});
...
var store = new _vuex2.default.Store({
    ...
    actions: {
        asyncIncrement0: function asyncIncrement0(_ref) {
        ...
        asyncIncrement: function asyncIncrement(_ref2) {
            var _this = this;
        ...
        asyncDecrement: function asyncDecrement(_ref3) {
            var _this2 = this;
                ...
                return _regenerator2.default.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return dispatch('asyncIncrement');
...
exports.default = {
    ...
    methods: {
        ...
        replaceItem: function replaceItem() {
            this.items[0].message = 'Replaced';
            // Vue.set(this.items, 0, {message: 'Replaced'});
        }
    }
}; //
//
...
exports.default = {
    ...
    methods: (0, _extends3.default)({
        increment10: function increment10() {
            this.$store.commit('increment', {
                amount: 10
            });
        },
        decrement10: function decrement10() {
            this.$store.commit({
                type: 'decrement',
                amount: 10
            });
    ...
    }, (0, _vuex.mapMutations)(['increment', 'decrement']), (0, _vuex.mapActions)(['asyncIncrement', 'asyncDecrement']))
}; //
//
//
//
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(37), __webpack_require__(89)))
...
module.exports={render:function (){with(this) {
  return _h('div', {
    staticClass: "test"
  }, [_h('span', ["Test GG " + _s(a)]), " ", (Math.random() < 0.8) ? _h('test') : _e()])
}},staticRenderFns: []}
...
module.exports={render:function (){with(this) {
  return _h('div', [_h('h1', [_s(count)]), " ", _h('button', {
    on: {
      "click": increment
    }
  }, ["+"]), " ", _h('button', {
...
module.exports={render:function (){with(this) {
  return _h('div', {
  ...
  }, [_m(0), " ", _h('p', ["written by " + _s(author)]), " ", _h('p', {
    staticClass: "red",
    class: {
      green: false
    }
  }, ["Original message: \"" + _s(message) + "\""]), " ", _h('p', ["Computed reversed message: \"" + _s(reversedMessage) + "\""]), " ", (true) ? _h('h1', ["Yes"]) : _e(), " ", _h('ul', [_l((items), function(item) {
    return _h('li', [_s(item.message)])
  })]), " ", _h('ul', [_l((3), function(n) {
    return _h('li', [_s(n)])
  })]), " ", _h('button', {
    on: {
      "click": addItem
    ...
    domProps: {
      "checked": Array.isArray(checkedNames) ? _i(checkedNames, "jack") > -1 : _q(checkedNames, true)
    },
    on: {
    ...
    domProps: {
      "checked": Array.isArray(checkedNames) ? _i(checkedNames, "John") > -1 : _q(checkedNames, true)
    },
    on: {
      "change": function($event) {
        var $$a = checkedNames,
    ...
    domProps: {
      "checked": Array.isArray(checkedNames) ? _i(checkedNames, "Mike") > -1 : _q(checkedNames, true)
    },
    on: {
      "change": function($event) {
        var $$a = checkedNames,
  ...
  }), " ", _m(5), " ", _m(6), _m(7), " ", _h('span', ["Checked names: " + _s(checkedNames)]), " ", _m(8), _m(9), " ", _h('input', {
    directives: [{
      name: "model",
  ...
  }), " ", _h('p', ["Message is: " + _s(message)])])
}},staticRenderFns: [function (){with(this) {
  return _h('h3', ["I am a 签名. "])
}},function (){with(this) {
  return _h('br')
}},function (){with(this) {
  return _h('br')
